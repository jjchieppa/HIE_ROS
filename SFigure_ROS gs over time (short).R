...
tiff(file = "Visual_ROS gs over time (short).tiff", height = 8, width = 12, res = 600,units = "in", compression = "zip+p")

par(mfrow = c(3,1), mar = c(0, 0, 0, 0), cex.lab = 1.3, omi = c(1, 1, 0.5, 1))

plot(gs.max ~ Date, lrye, pch = "", ylim = c(0,750), xaxt = "n", yaxt = "n")
axis(2, at = seq(0,750,150), cex.axis = 1.5, las = 2)
points(gs.max ~ Date, crye, pch = 1, cex = 2, col = "black")
points(gs.max ~ Date, srye, pch = 1, cex = 2, col = "red")
abline(v = as.Date("2018-6-20"), lty = 3)
abline(v = as.Date("2018-9-6"), lty = 3)
abline(v = as.Date("2018-9-13"), lty = 3)
abline(v = as.Date("2018-9-20"), lty = 3)
...
points(as.numeric(ROS2$ROS2_L_M3_Avg.mean*5000) ~ ROS1$Date, type = "l", lty = 1, col = "red") #short
axis(4, at = seq(0,750,150), labels = c("0","3","6","9","12","15"), cex.axis = 1.5, las = 2)

plot(gs.max ~ Date, lrye, pch = "", ylim = c(0,750), xaxt = "n", yaxt = "n")
axis(2, at = seq(0,750,150), cex.axis = 1.5, las = 2)
points(gs.max ~ Date, cfes, pch = 1, cex = 2, col = "black")
points(gs.max ~ Date, sfes, pch = 1, cex = 2, col = "red")
abline(v = as.Date("2018-6-20"), lty = 3)
abline(v = as.Date("2018-9-6"), lty = 3)
abline(v = as.Date("2018-9-13"), lty = 3)
abline(v = as.Date("2018-9-20"), lty = 3)
...
par(new = T)
points(as.numeric(ROS3$ROS3_A_P1_Avg.mean*5000) ~ ROS1$Date, type = "l", lty = 1) #Amb
points(as.numeric(ROS2$ROS2_L_F4_Avg.mean*5000) ~ ROS1$Date, type = "l", lty = 1, col = "red") #short
axis(4, at = seq(0,750,150), labels = c("0","3","6","9","12","15"), cex.axis = 1.5, las = 2)

plot(gs.max ~ Date, lrye, pch = "", ylim = c(0,750), xaxt = "n", yaxt = "n")
axis(2, at = seq(0,750,150), cex.axis = 1.5, las = 2)
points(gs.max ~ Date, cpha, pch = 1, cex = 2, col = "black")
points(gs.max ~ Date, spha, pch = 1, cex = 2, col = "red")
abline(v = as.Date("2018-6-20"), lty = 3)
abline(v = as.Date("2018-9-6"), lty = 3)
abline(v = as.Date("2018-9-13"), lty = 3)
abline(v = as.Date("2018-9-20"), lty = 3)
...
mtext(side = 3, outer = T, "Short Drought", cex = 1.5, padj = 0)
